"""
Django settings for notificar_web project.
...
SECRET_KEY = 'kca8am4o+s+pw*i@*c!b%0hog0=4_0x3h16@(-#nawvce__^zk'
...
ROOT_URLCONF = 'notificar_web.urls'
...
WSGI_APPLICATION = 'notificar_web.wsgi.application'
